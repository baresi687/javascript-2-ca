...
const GET_POSTS_URL = API_BASE_URL + '/posts?_author=true&limit=300'
...
export {API_BASE_URL, USER_SIGNUP_URL, USER_LOGIN_URL, GET_POSTS_URL, CREATE_POST_URL, GET_USER_POSTS_URL, EDIT_DELETE_USER_POST, GET_POST_DETAILS
}
